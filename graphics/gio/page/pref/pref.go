...
func (p *Page) LayoutPref(app *spsgio.Window, gtx layout.Context, param any) []layout.FlexChild {
...
func (p *Page) LayoutPrefTableStyle(app *spsgio.Window, gtx layout.Context) layout.Dimensions {
...
func (p *Page) TableStyle(app *spsgio.Window, gtx layout.Context) layout.Dimensions {
